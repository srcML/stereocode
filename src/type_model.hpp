...
public:
    ...
    void appendInheritedDataMembers(const std::unordered_map<std::string, variableModel>& fields_, 
                                    const std::unordered_set<std::string>& methodSignatures_,
                                    const std::unordered_set<std::string>& parentNames_,
                                    const std::unordered_map<std::string, variableModel>& inheritedFields_, 
                                    const std::unordered_set<std::string>& inheritedMethodSignatures_,
...
private:
    ...
    std::unordered_set<std::string>                         inheritedMethodSignatures;       // Inherited method signatures

...
public:
    ...
    void                     setFriendFunction                  (bool s)                { friendFunction = s;                               }
...
private:
    ...
    bool                                              variableCreatedWithNewReturned{false};      // Locals, parameters, or attributes created with the "new" operator
    ...
    bool                                              friendFunction{false};                      // Is friend function method? (C++ Only)
